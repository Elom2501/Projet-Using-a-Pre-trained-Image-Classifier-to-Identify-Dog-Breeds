...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """    
    # Print the CNN model architecture being used
    ...
    if print_incorrect_dogs and (
        ...
        for key in results_dic:
            ...
            # Labels disagree about whether the image is a dog
    ...
    if print_incorrect_breed and (
        ...
        for key in results_dic:
            ...
            # Both say it is a dog, but the breed does not match
            if (
                sum(results_dic[key][3:]) == 2 and
                results_dic[key][2] == 0
            ):
                print("Pet Image Label:",results_dic[key][0],"Classifier Label:",results_dic[key][1] )
